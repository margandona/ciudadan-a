...
- [x] **Instrucciones**: panel "¿Cómo juego en la granja?" en la granja (incluye "Ampliar
      ...
      **"¿Cómo usar?"**.
- [x] **Colapsar la parcela**: botón **"Ocultar/Mostrar cultivos"** (estado persistido) y
      **ocultado automático al empezar a colocar un objeto** para dejar el mapa libre a los adornos.
