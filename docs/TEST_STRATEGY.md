...
- **Accesibilidad y performance (FASE 15):** axe 0 violaciones en 11 rutas (WCAG 2.2 AA); Lighthouse Perf 89 / A11y 100 / BP 96 / SEO 91 (login, móvil throttled); LCP 3.1 s, TBT 0, CLS 0. Ver `docs/INFORME_PERFORMANCE_ACCESIBILIDAD_F15.md`.
