...
- **Usabilidad del mapa**: la escena ocupa todo el ancho y la bandeja **"Decora tu granja" va debajo** (ya no tapa el mapa); botón **"Ocultar/Mostrar cultivos"** que **colapsa la parcela** para dejar el mapa libre y colocar adornos; botón **"＋ Ampliar parcela"**; panel de instrucciones "¿Cómo juego en la granja?" y botón **Tienda** arriba.
