...
- **Usabilidad del mapa**: la escena ocupa todo el ancho y la bandeja **"Decora tu granja" va debajo** (ya no tapa el mapa); botón **"＋ Ampliar parcela"**; panel de instrucciones "¿Cómo juego en la granja?" y botón **Tienda** arriba.
- **Capturas**: granja en `docs/assets/granja-ciudadana.png` e interior en `docs/assets/granja-casa.png` (script `scripts/screenshot-farm.mjs`).
