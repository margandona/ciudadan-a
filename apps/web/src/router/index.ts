...
const routes: RouteRecordRaw[] = [
  { path: "/login", name: "login", component: () => import("@/views/LoginView.vue"), meta: { public: true } },
  {
    ...
    children: [
      ...
      {
        path: "teacher/courses/:courseId/live",
        name: "course-live",
        component: () => import("@/features/classes/LiveCourseView.vue"),
        meta: { roles: [ROLES.PROFESOR, ROLES.ADMIN, ROLES.MASTER] },
        props: true,
      },
      {
      ...
      {
        path: "teacher/classes/:classId/results",
        name: "teacher-class-results",
        component: () => import("@/features/classes/MissionResultsView.vue"),
        meta: { roles: [ROLES.PROFESOR, ROLES.ADMIN, ROLES.MASTER] },
        props: true,
      },
      {
        path: "teacher/classes/:classId/plan",
        name: "teacher-class-plan",
        component: () => import("@/features/classes/ClassPlanView.vue"),
        meta: { roles: [ROLES.PROFESOR, ROLES.ADMIN, ROLES.MASTER] },
        props: true,
      },
      {
      ...
      {
        path: "teacher/classes/:classId/quizzes/:quizId/live",
        name: "teacher-live-quiz",
        component: () => import("@/features/quizzes/LiveQuizHost.vue"),
        meta: { roles: [ROLES.PROFESOR, ROLES.ADMIN, ROLES.MASTER] },
        props: true,
      },
      {
      ...
      },
      {
        path: "student/study",
        name: "student-study",
        component: () => import("@/features/study/StudentStudyView.vue"),
        meta: { roles: [ROLES.ESTUDIANTE] },
      },
      {
        path: "student/farm",
        name: "student-farm",
        component: () => import("@/features/farm/FarmView.vue"),
        meta: { roles: [ROLES.ESTUDIANTE] },
      },
      {
        path: "student/farm/concept/:level",
        name: "student-concept-quiz",
        component: () => import("@/features/farm/ConceptQuizView.vue"),
        meta: { roles: [ROLES.ESTUDIANTE] },
        props: true,
      },
      {
      ...
      {
        path: "join/:code",
        name: "student-live-join",
        component: () => import("@/features/quizzes/LiveQuizJoin.vue"),
        meta: { roles: [ROLES.ESTUDIANTE] },
        props: true,
      },
      {
